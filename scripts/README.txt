...
Note: 1) "SupplementaryTable12.Data/" contains files of the number of NLRs assigned per 1 Mb window of the reference genome (CM334) for each accession.
      2) The output file names are "NLRsPerWindow.Total.1Mb.all.enriched.txt" and "NLRsPerWindow.Total.1Mb.enriched.txt".
